...
<head>
    <meta charset="utf-8">
    <meta name="keywords" content="Startseite, Musikschule, Tübingen, Unterricht, Klavier">
    <meta name="description" content="Willkommen, dies ist die Webpräsents der Musikschule Tübinge, Klavier-Unterricht">
    <meta name="author" content="Felix, Giulio, Timo, Emre">
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <title>Musikschule Tübingen - <?php echo $postOBJ->getPostTitle(); ?> Erwachsene</title>
    ...
    <div class="container">
        <div class="navigation">
            ...
            <div class="navigation_link_helper">
                <a href="../../index.html">Startseite/</a><a href="uebersicht-instrumente-erwachsene.php"
                    target="_self">Angebot/</a><a href="uebersicht-instrumente-erwachsene.php" target="_self">Erwachsene/</a><a href="klavier.html" target="_self"><?php echo $postOBJ->getPostTitle(); ?></a>
            </div>
        ...
        <img src="../../images/fraum-spielt-klavier.png" alt="No Image avaible">
